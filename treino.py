...
def padronizar_imagens(img_caminho):
    imagem = cv2.imread(img_caminho, cv2.IMREAD_GRAYSCALE) #ja abre a imagem em escala de cinza
    imagem = cv2.resize(imagem, (200,200), interpolation=cv2.INTER_LANCZOS4) #imagem, tamanho de saida, e interpolação
